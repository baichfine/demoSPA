export const consts = {
  ...
  GET_ALERT: 'getAlert',
  //Data states
  ARR_NAME_MENU: ['Частным лицам', 'Бизнесу', 'Еще'],
  ARR_CLASS_NAME_MENU: ['navBtn', 'navBtn', 'navBtn'],
  ARR_PERSON_NAME: ['Физические лица', 'Юридические лица'],
  ARR_PERSON_ICON: ['$iconAccount', '$iconAccountGroup'],
  ...
  ARR_SEARCH: [
    {
      title: 'Почему Банки отказывают в выпуске кредитной карты',
      subtitle: 'Кредитные карты',
    },
    {
      title: 'Обслуживание карты',
      subtitle: 'Дебетовые карты',
    },

    {
      title: 'Как перевести деньги с кредитной карты',
      subtitle: 'Кредитные карты',
    },

    {
      title: 'Карты Татсоцбанк',
      subtitle: 'Банк',
    },
